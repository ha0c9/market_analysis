    ...
    *,
    ...
    prompt = {
        ...
        "instructions": (
            ...
            "这不是投资建议，不要给买卖点或目标价。"
            "若 focusKind=tape 或侧重点是盘前/复盘/资金流入/尾盘拉升/涨停/龙虎榜等盘面现象："
            "先对照 quotes 里行业 ETF 的涨跌找出昨日/上一交易日领涨领跌板块，再写 sectorOutlook，不要默认半导体或银行证券保险；"
            "隔夜外盘只作背景。若农业/种业/消费等 ETF 明显强于大盘，必须点名并寻找对应新闻。"
